...
const StudentDisciplina = () => {
  ...
  const { disciplina, turma, aulas, materiais, myGrades } = data;
    ...
    <div className="bg-[#f8f9fa] dark:bg-[#020617] min-h-screen font-sans overflow-y-auto">
      ...
      <main className="max-w-[1200px] mx-auto px-6 py-10 flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-2">
           ...
           <h1 className="text-4xl font-black uppercase tracking-tight text-slate-900 dark:text-white">{disciplina.name} ({disciplina.code})</h1>
           <p className="text-[11px] font-black uppercase tracking-[0.2em] text-[#F59E0B] mt-2">
              TURMA: {turma.name} • {turma.shift} • {turma.semester}
           </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
           ...
           <div className="bg-white dark:bg-[#0B0F19] border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm flex items-center justify-between overflow-hidden relative">
              <div className="relative z-10">
                 <p className="text-[10px] font-black text-[#F59E0B] uppercase tracking-widest mb-2">CARGA HORÁRIA</p>
                 <p className="text-4xl font-black text-slate-900 dark:text-white">{disciplina.workload || '80h'}</p>
              </div>
              <span className="material-symbols-outlined text-slate-100 dark:text-slate-800 text-6xl absolute right-[-10px] bottom-[-10px]">timer</span>
           </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
           ...
           <div className="lg:col-span-2 flex flex-col gap-10">
              ...
              <div className="flex flex-col gap-6">
                 ...
                 <div className="bg-white dark:bg-[#0B0F19] border border-slate-200 dark:border-slate-800 p-8 rounded-2xl relative">
                    ...
                    <div className="relative z-10 space-y-4 max-w-2xl text-slate-700 dark:text-slate-300">
                       <p className="text-sm font-bold italic border-l-4 border-[#F59E0B] pl-4 mb-8 text-slate-900 dark:text-white">
                          Objetivo: Capacitar o acadêmico no desenvolvimento de software robusto aplicando padrões de projeto e arquitetura de microserviços.
                       </p>
                       <div className="space-y-2">
                          <p className="text-xs font-black text-slate-400 uppercase tracking-widest">TÓPICOS PRINCIPAIS</p>
                          <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-2 text-xs font-bold">
                             ...
                             <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-[#F59E0B] rounded-full"></span> Integração Contínua</li>
                          </ul>
                       </div>
                       <div className="pt-6">
                          <button 
                             onClick={() => navigate(`/student/ementa/${disciplina.id}`)}
                             className="text-[10px] font-black uppercase tracking-[0.2em] text-[#F59E0B] hover:text-[#D97706] transition-colors flex items-center gap-2"
                          >
                             VER EMENTA COMPLETA <span className="material-symbols-outlined text-[14px]">arrow_forward</span>
                          </button>
                       </div>
                    </div>
                 </div>
           ...
           <div className="flex flex-col gap-6">
              <h2 className="text-xs font-black uppercase tracking-[0.20em] text-slate-500">DETALHES DE FREQUÊNCIA</h2>
              ...
              <div className="bg-white dark:bg-[#0B0F19] border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden divide-y divide-slate-100 dark:divide-slate-800">
                 {aulas.filter(a => a.disciplinaId === disciplina.id).map((aula) => (
              ...
              <div className="bg-white dark:bg-[#0B0F19] p-8 rounded-2xl border border-slate-200 dark:border-slate-800 flex flex-col items-center justify-center text-center gap-4">
                 <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] leading-tight">PRECISA DE AJUDA COM ESTA MATÉRIA?</p>
