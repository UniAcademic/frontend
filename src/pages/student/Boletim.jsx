  ...
  return (
    <div className="bg-[#f8f9fa] dark:bg-[#0B0F19] min-h-screen font-sans">
      ...
      <main className="max-w-[1200px] mx-auto px-6 py-10 flex flex-col gap-8">
        ...
        {/* Header & Filters */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-white dark:bg-[#020617] p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
           <div>
              <h2 className="text-3xl font-black text-slate-900 dark:text-white uppercase tracking-tight">Boletim AcadÃªmico</h2>
              <p className="mt-1 text-slate-500 dark:text-slate-400 font-bold uppercase text-[10px] tracking-widest">
                 HISTÃ“RICO DE DESEMPENHO â€¢ {semestre}
              </p>
           </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
           <div className="bg-white dark:bg-[#020617] p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
              <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">CRA DO PERÃODO</p>
              <p className="text-3xl font-black text-slate-900 dark:text-white">{cra}</p>
           </div>
           <div className="bg-white dark:bg-[#020617] p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
              <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">CRÃ‰DITOS ACUMULADOS</p>
              <p className="text-3xl font-black text-slate-900 dark:text-white">{totalCreditos}</p>
           </div>
           <div className="bg-white dark:bg-[#020617] p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
              <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">APROVAÃ‡Ã•ES</p>
           ...
           <div className="bg-[#020617] p-6 rounded-2xl border border-[#1E293B] shadow-sm flex flex-col justify-center">
              <p className="text-[10px] font-black uppercase tracking-widest text-[#F59E0B] mb-2">SITUAÃ‡ÃƒO GERAL</p>
              <div className="inline-flex">
                 <span className="text-white font-black uppercase tracking-[0.2em] text-xs">REGULAR</span>
              </div>
           </div>
        </div>
              ...
              <table className="w-full text-left border-collapse min-w-[900px]">
                 <thead>
                    <tr className="bg-slate-50 dark:bg-[#0B0F19] border-b border-slate-100 dark:border-slate-800">
                       ...
                       <th className="px-6 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 text-center">MÃ‰DIA</th>
                       <th className="px-6 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 text-center">FALTAS</th>
                       <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 text-right">SITUAÃ‡ÃƒO</th>
                    </tr>
                 </thead>
                    ...
                    {disciplinas.map((disc) => (
                       <tr key={disc.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/10 transition-colors">
                          <td className="px-8 py-6">
                             ...
                             <div className="text-[9px] text-slate-400 uppercase tracking-widest font-bold mt-1">{disc.code} â€¢ 80H</div>
                          </td>
